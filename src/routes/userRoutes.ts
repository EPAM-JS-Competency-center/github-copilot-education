...
export function setRoutes(app: Express) {
    ...
    app.get('/users', requireAuth, controller.listUsers.bind(controller));
    ...
    app.get('/users/:id', requireAuth, controller.viewUser?.bind(controller) || ((req, res) => res.redirect('/users')));
}